...
public class Workflow_PaymentPage {
	...
	public String newuploadInvoice_Xpath = "//*[@id='work-flow-form']/div[3]/div[2]/form/div/div[2]/fieldset//div//label//a";
	...
	//amout paid
	public String amountPaid_Xpath = "//*[@id='AmountPaid']";
	//payment medium
	public String paymentMedium_Xpath = "//*[@id='PayMedium']";
	//receipt
	public String paymentReceipt_Xpath = "//*[@id='work-flow-form']//div//form//div//fieldset//div//label//a[contains(text(),'Receipt')]";
	public String newPaymentReceipt_Xpath = "//*[@id='work-flow-form']/div[3]/div[2]/form/div/div[2]/fieldset//div//label//a";
