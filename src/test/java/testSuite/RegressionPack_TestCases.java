...
public class RegressionPack_TestCases {

	//Test case run - yes/ no flag to be updated here
	public final static boolean TC1_runStatus = true; //Verify login screen default values
	public final static boolean TC2_runStatus = true; //Login application
	public final static boolean TC3_runStatus = false; // Testing failed test cases
